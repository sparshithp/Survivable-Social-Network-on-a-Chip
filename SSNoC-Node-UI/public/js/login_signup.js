...
//        $('#alert').text('Please ensure length of username is at least 3 characters');
//        $('#alert').show();
//        $('#passport_alert').remove();
//        return false;
//    }
